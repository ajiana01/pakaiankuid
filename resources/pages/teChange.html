...
<html lang="en">
  ...
  <div class="card text-bg-dark rounded-0 mb-5">
    <img src="../assets/img/BannerTechange.png" class="card-img" alt="Banner Techange">
   ...
   <!-- Alur start -->
   <h3><p class="text-center"><a href="#" class="text-center text-black fw-bold mt-5" >Alur TeChange</a></p></h3>
      <div class="container text-center mt-5" style="max-width: 80%;">
        <div class="row align-items-center justify-content-center">

          <div class="col">
            <div class="row align-items-center justify-content-center mb-2 p-0">
              <div class="col-3 m-0 p-0">
                <img src="../assets/img/isi-data-icon.png" class="img-thumbnail border-0 bg-no" alt="Isi data">
              </div>
              <div class="col-5 m-0 p-0">
                <h3 class="fw-bold">Isi Data</h3>
              </div>
            </div> 
            <div class="col-sm-12">
              <p class="fs-6 fw-light lh-1" style="text-align: justify;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</p>
            </div>
          </div>

          <div class="col m-0 p-0" style="max-width: 70px;">
          ...
          <div class="col">
            <div class="row align-items-center justify-content-center mb-2 p-0">
              <div class="col-4 m-0 p-0">
                <img src="../assets/img/konfirmasi-kon.png" class="img-thumbnail border-0 bg-no" alt="Konfirmasi">
              </div>
              <div class="col-5 m-0 p-0">
          ...
          <div class="col">
            <div class="row align-items-center justify-content-center mb-2 p-0">
              <div class="col-3 m-0 p-0">
                <img src="../assets/img/pilih-pakaian-ikon.png" class="img-thumbnail border-0 bg-no" alt="Pilih pakaian">
              </div>
              <div class="col-6 m-0 p-0">
                <h3 class="fw-bold">Pilih Pakaian</h3>
              </div>
            </div> 
            <div class="col-sm-12">
              <p class="fs-6 fw-light lh-1" style="text-align: justify;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</p>
   ...
   <!-- Form TeChange Start -->
   <h3><p class="text-center"><a href="#" class="text-center text-black fw-bold mt-5" >Pengisian Data</a></p></h3>
  
   <div class="container align-items-center mt-5" style="max-width: 60%;">
    <div class="card">
      <div class="card-body p-5">
        
        <form>
          <div class="mb-3">
            <label for="techange-name" class="form-label">Judul</label>
            <input type="text" class="form-control" id="techange-name" placeholder="Nama Model Pakaian.">
          </div>
          <div class="mb-3">
            <label for="techange-desc" class="form-label">Deskripsi</label>
            <input type="text" class="form-control" id="techange-desc" placeholder="Deskripsikan model pakaian secara singkat.">
          </div>
          <label for="techange-img" class="form-label">Gambar</label>
          <div class="input-group mb-3">
            <input type="file" class="form-control" id="techange-img" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
            <button class="btn btn-outline-primary" type="button" id="inputGroupFileAddon04">Unggah</button>
          </div>
          <div class="container mt-4">
            <div class="text-center">
              <button type="submit" class="btn btn-primary fs-6 p-2" style="width: 8rem;">Konfirmasi</button>
            </div>
          </div>
        </form>
      </div>
